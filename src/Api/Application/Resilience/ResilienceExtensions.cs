...
using UrlShortener.Application.Resilience;
...
public static class ResilienceExtensions
{
    ...
    {
        app.MapGet("/health/circuit-breakers", async (IServiceProvider sp) =>
        {
            var pgCb = sp.GetRequiredService<ICircuitBreaker>();
            var externalCb = sp.GetService<InProcessCircuitBreaker>()?? new InProcessCircuitBreaker("external-service", sp.GetService<ILogger<InProcessCircuitBreaker>>());
